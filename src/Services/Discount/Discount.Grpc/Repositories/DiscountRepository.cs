...
public class DiscountRepository : IDiscountRepository
{
    ...
    public async Task<bool> CreateDiscount(Coupon coupon)
    {
        ...
        var result = await connection.ExecuteAsync
            ("INSERT INTO Coupon (ProductName, Description, Amount) VALUES (@ProductName, @ProductDescription, @Amount)",
            new { ProductName = coupon.ProductName, ProductDescription = coupon.Description, Amount = coupon.Amount });
